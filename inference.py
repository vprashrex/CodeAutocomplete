...
def format_prompt(user_prompt: str,system_message="this is the output/n"):
    return f"""{user_prompt}+' '+{user_prompt}"""
...
if __name__ == "__main__":
    ...
    llm = AutoModelForCausalLM.from_pretrained(
        os.path.abspath("models/gpt_bigcode-santacoder-ggml-q4_1.bin"),
